...
\begin{tabu}{cccccc|l}
		...
		\createfirstline{Prog. \& Markup Languages}{5}
			...
			\createitem{Groovy, C++, Objective-C, Basic, Jython}\inter \tableline
			\createitem{Matlab, Bash, Perl, PHP}\inter \tableline
	 ...
	 \createline{IDEs}{2}
			\createitem{SciTE, Gvim, vi, JEdit} \inter \tableline
